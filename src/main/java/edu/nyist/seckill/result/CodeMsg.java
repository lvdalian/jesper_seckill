package edu.nyist.seckill.result;
...
public class CodeMsg {
    ...
    public static CodeMsg VERIFY_CODE = new CodeMsg(500217, "验证码错误");
    public static CodeMsg VERIFY_EMPTY = new CodeMsg(500218, "验证码不能为空");
